  ...
  outputs =
    ...
    inputs.utils.lib.eachSystem
      ...
      (
        ...
        in
        {
          devShells.default = pkgs.mkShell.override { stdenv = pkgs.llvmPackages_14.stdenv; } rec {
...
shellHook = ''
    export GDBFLAGS="-iex 'set auto-load safe-path ${pkgs.lib.escapeShellArg (toString ./.)}'"
    alias gdb="gdb -x ${toString ./.gdbinit}"
  '';
          };
